...
bool CQ::EVEGroupMsg::setGroupSpecialTitle(std::string UniqueRank, long long ExpireTime)
{
	return !CQ::setGroupSpecialTitle(fromGroup, fromQQ, UniqueRank, ExpireTime);
}

bool CQ::EVEGroupMsg::setGroupWholeBan(bool WholeBan)
{
	return CQ::setGroupWholeBan(fromGroup, WholeBan);
}

bool CQ::EVEGroupMsg::setGroupAnonymous(bool Anonymous)
{
	return CQ::setGroupAnonymous(fromGroup, Anonymous);
}

bool CQ::EVEGroupMsg::setGroupCard(std::string NewGroupNickname)
{
	return CQ::setGroupCard(fromGroup, fromQQ, NewGroupNickname);
}

bool CQ::EVEGroupMsg::setGroupLeave(bool Dismiss)
{
	return CQ::setGroupLeave(fromGroup, Dismiss);
}
